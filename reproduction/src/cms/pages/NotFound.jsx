...
const texts = {
    DE: {
        title: 'Hier wächst nichts mehr',
        subtitle: 'Die Seite, die du suchst, wurde wohl schon abgeholzt.',
        cta: 'Zurück zur Startseite',
    },
    FR: {
        title: 'Plus rien ne pousse ici',
        subtitle: "La page que tu cherches a dû être abattue.",
...
const NotFound = () => {
    ...
    return (
        <main className="pt-28 pb-24 md:pb-32 min-h-[75vh] flex flex-col items-center justify-center px-6 text-center">
            {/* Seedling animation */}
            <div className="seedling-scene mb-8" aria-hidden="true">
                <div className="seedling-pot">
                    <div className="seedling-dirt" />
                </div>
            ...
            <h1 className="text-7xl md:text-9xl font-serif text-primary/20 font-bold leading-none hero-enter hero-enter-1">
                404
            </h1>
            <h2 className="text-2xl md:text-3xl font-serif text-primary mt-4 hero-enter hero-enter-2">
                {t.title}
            </h2>
            <p className="text-slate-500 mt-3 max-w-md text-base md:text-lg hero-enter hero-enter-2">
                {t.subtitle}
            </p>
            <Link
                to={ROUTES[language].home}
                className="mt-10 inline-flex items-center gap-2 px-8 py-3 bg-primary text-white font-bold rounded-full hover:bg-primary/90 transition-colors duration-300 text-sm uppercase tracking-widest hero-enter hero-enter-3"
            >
                {t.cta}
            </Link>
