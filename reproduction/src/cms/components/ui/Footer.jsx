...
const Footer = ({
    ...
    return (
        <>
        <footer className="bg-primary text-white py-8 px-6 min-h-[360px] lg:min-h-[220px]">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-8 lg:gap-10 text-center lg:text-left items-center lg:items-start">
                <div className="space-y-4 flex flex-col items-center lg:items-start max-w-sm">
                    <img
                    ...
                    {/* Social Icons — visible on mobile/tablet only */}
                ...
                <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-white/95 text-xs flex flex-col items-center lg:items-start text-center lg:text-left">
