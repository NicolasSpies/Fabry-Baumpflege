...
const Footer = () => {
    ...
    return (
        <footer className="bg-primary text-white py-12 px-6">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 text-center md:text-left items-center md:items-start">
                <div className="space-y-6 flex flex-col items-center md:items-start max-w-sm">
                    ...
                    <div className="flex gap-4">
                        <a
                            className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-all font-sans"
                            href="https://www.instagram.com/fabry_baumpflege"
                            target="_blank"
                ...
                <div className="space-y-6">
                    ...
                    <ul className="space-y-4 text-white/60 text-sm flex flex-col items-center md:items-start">
                        ...
                        <li className="flex items-center gap-3">
                            <span className="material-symbols-outlined text-white/80">phone</span>
            ...
            <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] text-white/30 uppercase tracking-[0.3em]">
