import{r as i,j as e,L as o}from"./vendor-react-D4_BVGvc.js";import{u as n,R as l}from"./index-DVFa3ZGh.js";import{u as f}from"./useCmsSeo-CqVl6pMy.js";import"./vendor-motion-CAmyiO-o.js";const r={DE:{title:"Hier wächst nichts mehr",subtitle:"Die Seite, die du suchst, wurde wohl schon abgeholzt.",cta:"Zurück zur Startseite"},FR:{title:"Plus rien ne pousse ici",subtitle:"La page que tu cherches a dû être abattue.",cta:"Retour à l'accueil"}},h=()=>{const{language:t,setPageReady:s}=n(),a=r[t]||r.DE;return f({title:t==="FR"?"Page introuvable | Fabry Baumpflege":"Seite nicht gefunden | Fabry Baumpflege",description:t==="FR"?"La page que vous cherchez n'existe pas.":"Die gesuchte Seite existiert nicht."}),i.useEffect(()=>{s(!0)},[]),e.jsxs("main",{className:"pt-28 pb-24 md:pb-32 min-h-[75vh] flex flex-col items-center justify-center px-6 text-center",children:[e.jsxs("div",{className:"seedling-scene mb-8","aria-hidden":"true",children:[e.jsx("div",{className:"seedling-pot",children:e.jsx("div",{className:"seedling-dirt"})}),e.jsx("div",{className:"seedling-stem"}),e.jsx("div",{className:"seedling-leaf seedling-leaf-left"}),e.jsx("div",{className:"seedling-leaf seedling-leaf-right"})]}),e.jsx("h1",{className:"text-7xl md:text-9xl font-serif text-primary/20 font-bold leading-none hero-enter hero-enter-1",children:"404"}),e.jsx("h2",{className:"text-2xl md:text-3xl font-serif text-primary mt-4 hero-enter hero-enter-2",children:a.title}),e.jsx("p",{className:"text-slate-500 mt-3 max-w-md text-base md:text-lg hero-enter hero-enter-2",children:a.subtitle}),e.jsx(o,{to:l[t].home,className:"mt-10 inline-flex items-center gap-2 px-8 py-3 bg-primary text-white font-bold rounded-full hover:bg-primary/90 transition-colors duration-300 text-sm uppercase tracking-widest hero-enter hero-enter-3",children:a.cta}),e.jsx("style",{children:`
                .seedling-scene {
                    position: relative;
                    width: 120px;
                    height: 140px;
